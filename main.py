...
# Load trained model
# =========================
# SVC model trained to predict disease based on symptoms
svc = pickle.load(open('svc.pkl', 'rb'))

# =========================
# Helper function to get all info about a disease
# =========================
def helper(dis):
    """
    Given a predicted disease, retrieve:
    - Description
    - Precautions
    - Medications
    - Recommended diet
    ...
    # Get precautions as a list (if available)
    ...
    # Return all info (precautions may be empty)
    return desc, pre[0] if pre else [], med, die, wrkout

# =========================
# Symptoms to input vector mapping
# =========================
...
# Mapping of model outputs to disease names
...
# =========================
# Convert user symptoms to predicted disease
# =========================
def get_predicted_value(symptoms):
    """
    Convert user symptoms into input vector for model and return predicted disease
    """
    input_vector = np.zeros(len(symptoms_dict))  # Initialize input vector with zeros
    for symptom in symptoms:
        if symptom in symptoms_dict:
            input_vector[symptoms_dict[symptom]] = 1  # Mark present symptoms
    # Predict and return disease name
